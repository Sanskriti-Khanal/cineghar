...
extension ThemeColorsExtension on BuildContext {
  ...
  Color get textSecondary60 =>
      isDarkMode ? AppColors.darkTextSecondary.withValues(alpha: 0.6) : const Color(0x996B7280);

  Color get textSecondary50 =>
      isDarkMode ? AppColors.darkTextSecondary.withValues(alpha: 0.5) : const Color(0x806B7280);
}
